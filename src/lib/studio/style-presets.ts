...
export const stylePresets: StylePreset[] = [
  ...
  },
  {
    ...
    picks: {
      ...
      backsplash: ["subway", "ivory"],
      "wall-tile": ["subway", "ivory"],
      floor: ["oak", "hex", "marble"],
      fixture: ["brushed nickel", "allowance"],
  ...
  },
  {
    ...
    picks: {
      cabinet: ["sage", "walnut", "custom"],
      countertop: ["butcher", "oak", "warm", "marble"],
      backsplash: ["zellige", "sea glass"],
      "wall-tile": ["penny", "zellige"],
      floor: ["oak", "lvp"],
      fixture: ["brass", "allowance"],
